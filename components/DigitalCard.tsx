...
export const DigitalCard: React.FC = () => {
  return (
    <div className="w-full max-w-[430px] p-4">
      <div className="bg-card-bg rounded-[28px] px-[26px] py-[32px] shadow-[0_18px_40px_rgba(0,0,0,0.25)]">
        
        {/* Avatar Wrapper */}
        <div className="flex justify-center mb-[18px]">
          <div className="w-[134px] h-[134px] rounded-full bg-accent-gold p-[3px] flex items-center justify-center">
            {/* Using a placeholder image that looks like a profile picture */}
            <img 
              src="https://res.cloudinary.com/ddpujsrsg/image/upload/v1768340727/tu-foto-fran_1_irsuqn.png" 
        ...
        {/* Name & Role */}
        <h1 className="text-center font-bold text-[1.6rem] text-text-main mb-1">
          FRAN GALES
        </h1>
        ...
        {/* Description */}
        <p className="text-[0.96rem] leading-[1.55] text-text-body mb-[26px] text-left mx-auto">
        ...
        <div className="flex flex-col gap-[10px] mb-[26px]">
          ...
          {/* WhatsApp Button */}
          <a
            className="flex items-center justify-center gap-[10px] rounded-[14px] py-[13px] px-[16px] text-[0.96rem] no-underline border-none cursor-pointer transition-transform duration-200 ease-in-out hover:-translate-y-px hover:shadow-[0_10px_22px_rgba(0,0,0,0.25)] bg-btn-primary-bg text-btn-primary-text shadow-[0_8px_18px_rgba(0,0,0,0.35)] animate-sideMove"
            href="https://wa.me/34641066377?text=Hola%20Fran%2C%20he%20visto%20tu%20tarjeta%20digital."
            target="_blank"
            rel="noopener noreferrer"
          >
            <span className="w-[22px] h-[22px]">
              <svg viewBox="0 0 32 32" fill="#ffffff" className="w-full h-full">
          ...
          {/* Web Button */}
          <a
            className="flex items-center justify-center gap-[10px] rounded-[14px] py-[13px] px-[16px] text-[0.96rem] no-underline border-none cursor-pointer transition-transform duration-200 ease-in-out hover:-translate-y-px hover:shadow-[0_10px_22px_rgba(0,0,0,0.25)] bg-btn-secondary-bg text-btn-secondary-text"
          ...
          >
            <span className="w-[22px] h-[22px]">
              <svg viewBox="0 0 24 24" fill="#1f2933" className="w-full h-full">
        ...
        <div className="text-center">
          <div className="font-bold text-[1.25rem] text-text-main mb-[3px]">
            masclientes.vip
          </div>
          <div className="text-[0.86rem] text-muted-text">
