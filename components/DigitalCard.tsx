...
export const DigitalCard: React.FC = () => {
  return (
    <div className="w-full max-w-[280px] mx-auto p-3">
      <div className="bg-white rounded-[16px] shadow-[0_10px_30px_rgba(0,0,0,0.15)] overflow-hidden">
        ...
        <div className="bg-white pt-4 pb-2 text-center">
          <h1 className="text-[#0b2744] font-bold text-xl uppercase tracking-wide leading-none">
            FRAN GALES
          </h1>
        </div>

        {/* Dark Blue Info Section */}
        <div className="bg-[#0b2744] py-4 px-4 text-center">
          <h2 className="text-white text-xs font-medium mb-2">
            Estrategia y visibilidad moderna
          </h2>
          <p className="text-white text-[0.65rem] font-light leading-relaxed opacity-90">
        ...
        <div className="bg-white p-3">
          <div className="flex gap-2 justify-center items-stretch">
            ...
            <a
              ...
              className="flex-1 bg-[#bfdbfe] text-[#1e3a8a] rounded-lg py-2 px-1 flex flex-col items-center justify-center gap-1 hover:opacity-90 transition-all shadow-md group"
            >
              <span className="text-base group-hover:scale-110 transition-transform">🌐</span>
              <span className="text-[0.6rem] font-bold leading-tight text-center">Ver página web</span>
            </a>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 bg-[#0b2744] text-white rounded-lg py-2 px-1 flex flex-col items-center justify-center gap-1 hover:opacity-90 transition-all shadow-md group animate-heartbeat"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 bg-[#0077b5] text-white rounded-lg py-2 px-1 flex flex-col items-center justify-center gap-1 hover:opacity-90 transition-all shadow-md group"
            >
              ...
              <div className="flex flex-col items-center leading-none">
                <span className="text-[0.55rem] opacity-90">Conectar en</span>
                <span className="text-[0.6rem] font-bold">LinkedIn</span>
              </div>
            </a>
          ...
          <div className="text-center mt-3">
            <a href="https://masreseñas.es" target="_blank" rel="noopener noreferrer" className="block text-[#0b2744] font-bold text-sm hover:underline decoration-2 underline-offset-4">
              masreseñas.es
            </a>
