  ...
  return (
    <div className="w-full max-w-[400px] mx-auto p-4">
      <div className="bg-white rounded-[20px] shadow-[0_10px_30px_rgba(0,0,0,0.15)] overflow-hidden">
        ...
        {/* Header Image - Adjusted Aspect Ratio to show more body (prevents cropping) */}
        <div className="w-full aspect-[3/4] relative">
          <img 
            src="https://res.cloudinary.com/ddpujsrsg/image/upload/v1768584168/WhatsApp_Image_2026-01-16_at_17.47.56_chhxoh.jpg" 
        ...
        <div className="bg-white pt-6 pb-3 text-center">
          <h1 className="text-[#0b2744] font-bold text-[1.8rem] uppercase tracking-wide leading-none">
            FRAN GALES
          </h1>
        </div>
        ...
        <div className="bg-[#0b2744] py-6 px-6 text-center">
          <h2 className="text-white text-[1rem] font-medium mb-3">
            Estrategia y visibilidad moderna
          </h2>
          <p className="text-white text-[0.9rem] font-light leading-relaxed opacity-90">
        ...
        <div className="bg-white p-5">
          <div className="flex gap-3 justify-center items-stretch">
            ...
            <a
              ...
              className="flex-1 bg-[#bfdbfe] text-[#1e3a8a] rounded-xl py-3 px-2 flex flex-col items-center justify-center gap-2 hover:opacity-90 transition-all shadow-md group"
            >
              <span className="text-xl group-hover:scale-110 transition-transform">🌐</span>
              <span className="text-[0.7rem] font-bold leading-tight text-center">Ver página web</span>
            </a>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 bg-[#0b2744] text-white rounded-xl py-3 px-2 flex flex-col items-center justify-center gap-2 hover:opacity-90 transition-all shadow-md group animate-heartbeat"
            >
              ...
              <span className="text-[0.7rem] font-medium">WhatsApp</span>
            </a>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 bg-[#0077b5] text-white rounded-xl py-3 px-2 flex flex-col items-center justify-center gap-2 hover:opacity-90 transition-all shadow-md group"
            >
